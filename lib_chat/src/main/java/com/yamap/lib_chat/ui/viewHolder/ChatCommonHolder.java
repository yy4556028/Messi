 ...
 */
public abstract class ChatCommonHolder<T> extends RecyclerView.ViewHolder {

    public ChatCommonHolder(Context context, ViewGroup root, int layoutRes) {
     ...
     * @param <VH>
     */
    public interface ViewHolderCreator<VH extends ChatCommonHolder> {
