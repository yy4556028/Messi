package com.yamap.lib_chat.keyboard.adpater;
...
public class EmoticonAdapter<T> extends BaseAdapter {
    ...
    public EmoticonAdapter(Context context, EmoticonPageEntity emoticonPageEntity, EmoticonClickListener onEmoticonClickListener) {
        ...
        this.mDefalutItemHeight = this.mItemHeight = (int) CommonUtil.dp2px(32);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.chat_keyboard_emoticon_item, null);
            viewHolder.rootView = convertView;
            viewHolder.lyt = (LinearLayout) convertView.findViewById(R.id.chat_keyboard_emoticon_item_lyt);
            viewHolder.icon = (ImageView) convertView.findViewById(R.id.chat_keyboard_emoticon_item_icon);
    ...
    protected void updateUI(ViewHolder viewHolder, ViewGroup parent) {
        if(mDefalutItemHeight != mItemHeight){
            viewHolder.icon.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, mItemHeight));
        }
        ...
        viewHolder.lyt.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, realItemHeight));
    }
