...
public class EmoticonsToolBar extends RelativeLayout {
    ...
    public EmoticonsToolBar(Context context) {
        this(context, null);
    }

    public EmoticonsToolBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mInflater.inflate(R.layout.chat_keyboard_emoticon_toolbar, this);
        this.mContext = context;
        mBtnWidth = (int) CommonUtil.dp2px(56);
        hsv_toolbar = (HorizontalScrollView) findViewById(R.id.chat_keyboard_emotion_toolBar_hrzScrollView);
        ly_tool = (LinearLayout) findViewById(R.id.chat_keyboard_emotion_toolBar_lyt);
    }
    ...
    protected View getCommonItemToolBtn() {
        return mInflater == null ? null : mInflater.inflate(R.layout.chat_keyboard_toolbtn, null);
    }
    ...
    protected void initItemToolBtn(View toolBtnView, int rec, final PageSetEntity pageSetEntity, OnClickListener onClickListener){
        ImageView iv_icon = (ImageView) toolBtnView.findViewById(R.id.chat_keyboard_btn_icon);
        if (rec > 0) {
    ...
    protected View getToolBgBtn(View parentView) {
        return  parentView.findViewById(R.id.chat_keyboard_btn_icon);
    }
    ...
    public void setToolBtnSelect(String uuid) {
        ...
        for (int i = 0; i < mToolBtnList.size(); i++) {
            ...
            if (object != null && object instanceof PageSetEntity && uuid.equals(((PageSetEntity) object).getUuid())) {
                ...
                mToolBtnList.get(i).setBackgroundResource(R.drawable.btn_tool_btn_bg);
            }
        }
