...
public class EmoticonsIndicator extends LinearLayout {
    ...
    public EmoticonsIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mLeftLayoutParams.leftMargin = (int) CommonUtil.dp2px(MARGIN_LEFT);
    }
