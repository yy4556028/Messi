...
public class WaterMarkInfo {
    ...
    private WaterMarkInfo(int degrees, int textColor, int textSize, boolean textBold, int dx, int dy, Paint.Align align,int top) {
        mDegrees = degrees;
    ...
    public static class Builder {
        ...
        public WaterMarkInfo generate() {
            return new WaterMarkInfo(mDegrees, mTextColor, mTextSize, mTextBold, mDx, mDy, mAlign,mTop);
        }
    }
