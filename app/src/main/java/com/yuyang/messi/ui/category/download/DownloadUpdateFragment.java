...
public class DownloadUpdateFragment extends BaseFragment {
    ...
    private void initView() {
        XRecyclerView recyclerView = $(R.id.fragment_download_recycleView);
    ...
    public void updateData() {
        ...
        if (DownloadActivity.gameBeanList != null) {
            for (AppBean gameBean : DownloadActivity.gameBeanList) {
                if (AppInfoUtil.isApkInstalled(getContext(), gameBean.getAppPackageName()) &&
                        AppInfoUtil.isVersionOutdated(AppInfoUtil.getAppVersionName(), gameBean.getAppVersion())) {
