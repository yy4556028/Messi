...
public class BiuEditText extends EditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        biuTextColor = typedArray.getColor(R.styleable.BiuEditStyle_biu_text_color, Color.WHITE);
        biuTextStartSize = typedArray.getDimension(R.styleable.BiuEditStyle_biu_text_start_size, 20);
