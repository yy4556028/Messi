 ...
 */
package com.yuyang.messi.view.Indicator.vp_indicator;
...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultFooterColor = Color.CYAN;
        final float defaultFooterLineHeight = PixelUtils.dp2px(2);
        final int defaultFooterIndicatorStyle = 2;
        final float defaultFooterIndicatorHeight = PixelUtils.dp2px(4);
        final float defaultFooterIndicatorUnderlinePadding = PixelUtils.dp2px(20);
        final float defaultFooterPadding = PixelUtils.dp2px(7);
        ...
        final float defaultTextSize = PixelUtils.dp2px(15);
        final float defaultTitlePadding = PixelUtils.dp2px(5);
        final float defaultClipPadding = PixelUtils.dp2px(4);
        final float defaultTopPadding = PixelUtils.dp2px(7);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (curPageBound.left < leftClip) {
            //Try to crop to the screen (left side)
            clipViewOnTheLeft(curPageBound, curPageWidth, left);
        }
        if (curPageBound.right > rightClip) {
            //Try to crop to the screen (right side)
    ...
    /**
     * Set bounds for the right textView including crop padding.
     *
    ...
    /**
     * Set bounds for the left textView including crop padding.
     *
     * @param curViewBound current bounds.
     * @param curViewWidth width of the view.
     */
