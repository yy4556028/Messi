...
public class AudioLrcView extends View {
	...
	public AudioLrcView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public AudioLrcView(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	private void inflateAttributes(AttributeSet attrs) {
		...
		TypedArray ta = getContext().obtainStyledAttributes(attrs,
				R.styleable.Lrc);
		mTextSize = ta.getDimension(R.styleable.Lrc_lrcTextSize, 50f);
		mRows = ta.getInteger(R.styleable.Lrc_rows, 5);
		mDividerHeight = ta.getDimension(R.styleable.Lrc_dividerHeight, 0f);
		...
		int currentTextColor = ta.getColor(R.styleable.Lrc_currentTextColor,
				getContext().getResources().getColor(R.color.cyan));
		ta.recycle();
		// </end>
