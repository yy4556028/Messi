...
public class CustomShapeSquareImageView extends CustomShapeImageView {
    ...
    public CustomShapeSquareImageView(Context context, int resourceId, int colorId, int shape, int svgRawResourceId) {
        super(context, resourceId, colorId, shape, svgRawResourceId);
    }
