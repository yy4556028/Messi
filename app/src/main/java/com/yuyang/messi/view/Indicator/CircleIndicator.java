package com.yuyang.messi.view.Indicator;
...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.oval_theme;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.oval_theme;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.oval_theme, R.drawable.oval_theme);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.oval_theme
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
