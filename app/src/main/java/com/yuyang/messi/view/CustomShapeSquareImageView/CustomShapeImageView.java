package com.yuyang.messi.view.CustomShapeSquareImageView;
...
public class CustomShapeImageView extends BaseImageView {
    ...
    public CustomShapeImageView(Context context, int resourceId, int colorId, int shape, int svgRawResourceId) {
        this(context);

        setImageDrawable(new ColorDrawable(getResources().getColor(colorId)));
        mShape = shape;
        mSvgRawResourceId = svgRawResourceId;
    }
