...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultSelectedColor = Color.CYAN;
        final int defaultUnselectedColor = Color.WHITE;
        final float defaultLineWidth = PixelUtils.dp2px(12);
        final float defaultGapWidth = PixelUtils.dp2px(4);
        final float defaultStrokeWidth = PixelUtils.dp2px(1);
