package com.yuyang.messi.view.Picker.common;
...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    protected View makeHeaderView() {
        ...
        topButtonLayout.setLayoutParams(new RelativeLayout.LayoutParams(MATCH_PARENT, (int) PixelUtils.dp2px(40)));
        ...
        int margin = PixelUtils.dp2px(20);
