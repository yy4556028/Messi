package com.yuyang.messi.view.Indicator.flyco.indicator;
...
import com.yuyang.messi.view.Indicator.flyco.indicator.base.PageIndicator;

import java.util.ArrayList;

public class FlycoPageIndicator extends LinearLayout implements PageIndicator {
    ...
    public FlycoPageIndicator(Context context, AttributeSet attrs) {
        ...
        indicatorWidth = ta.getDimensionPixelSize(R.styleable.FlycoPageIndicator_fpi_width, dp2px(6));
        indicatorHeight = ta.getDimensionPixelSize(R.styleable.FlycoPageIndicator_fpi_height, dp2px(6));
        indicatorGap = ta.getDimensionPixelSize(R.styleable.FlycoPageIndicator_fpi_gap, dp2px(8));
        cornerRadius = ta.getDimensionPixelSize(R.styleable.FlycoPageIndicator_fpi_cornerRadius, dp2px(3));
        strokeWidth = ta.getDimensionPixelSize(R.styleable.FlycoPageIndicator_fpi_strokeWidth, dp2px(0));
        strokeColor = ta.getColor(R.styleable.FlycoPageIndicator_fpi_strokeColor, Color.parseColor("#ffffff"));
        isSnap = ta.getBoolean(R.styleable.FlycoPageIndicator_fpi_isSnap, false);

        int selectColor = ta.getColor(R.styleable.FlycoPageIndicator_fpi_selectColor, Color.parseColor("#ffffff"));
        int unselectColor = ta.getColor(R.styleable.FlycoPageIndicator_fpi_unselectColor, Color.parseColor("#88ffffff"));
