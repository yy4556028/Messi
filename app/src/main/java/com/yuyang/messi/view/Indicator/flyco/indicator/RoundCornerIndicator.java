...
public class RoundCornerIndicator extends View implements PageIndicator {
    ...
    public RoundCornerIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        indicatorWidth = ta.getDimensionPixelSize(R.styleable.RoundCornerIndicator_rci_width, dp2px(6));
        indicatorHeight = ta.getDimensionPixelSize(R.styleable.RoundCornerIndicator_rci_height, dp2px(6));
        indicatorGap = ta.getDimensionPixelSize(R.styleable.RoundCornerIndicator_rci_gap, dp2px(8));
        cornerRadius = ta.getDimensionPixelSize(R.styleable.RoundCornerIndicator_rci_cornerRadius, dp2px(3));
        strokeWidth = ta.getDimensionPixelSize(R.styleable.RoundCornerIndicator_rci_strokeWidth, dp2px(0));
