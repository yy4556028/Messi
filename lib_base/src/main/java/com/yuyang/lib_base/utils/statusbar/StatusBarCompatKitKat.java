...
class StatusBarCompatKitKat {
     ...
     */
    private static View addFakeStatusBarView(Activity activity, Drawable background, int statusBarHeight) {
    ...
    static void setStatusBarBackground(Activity activity, Drawable background) {
        ...
        removeFakeStatusBarViewIfExist(activity);
        addFakeStatusBarView(activity, background, statusBarHeight);
        addMarginTopToContentChild(mContentChild, statusBarHeight);
