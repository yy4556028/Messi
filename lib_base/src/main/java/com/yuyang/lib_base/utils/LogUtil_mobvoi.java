...
public class LogUtil_mobvoi {
   ...
   * 设置全局的 tag
   *
   * @param level Where level is either VERBOSE, DEBUG, INFO, WARN, ERROR, ASSERT, or SUPPRESS.
...
//    SystemPropertiesIA.set("log.tag." + GLOBAL_LOG_TAG, level);
  ...
  /**
   * @deprecated Use {@link #v(String, Throwable, String)} instead.
   */
  @Deprecated
  ...
  public static void d(String tag, Throwable throwable) {
    log(Log.DEBUG, tag, null, throwable);
  }

  /**
   * @deprecated Use {@link #d(String, Throwable, String)} instead.
   */
  @Deprecated
  ...
  public static void d(String tag, Throwable tr, String msgFormat, Object... args) {
    log(Log.DEBUG, tag, msgFormat, tr, args);
  }
  ...
  /**
   * @deprecated Use {@link #w(String, Throwable, String, Object...)} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link #e(String, Throwable, String)} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link #e(String, Throwable, String, Object...)} instead.
   */
  @Deprecated
