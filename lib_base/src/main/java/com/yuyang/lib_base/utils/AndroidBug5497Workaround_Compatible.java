...
public class AndroidBug5497Workaround_Compatible {

    public static void assistActivity(Activity activity) {
        new AndroidBug5497Workaround_Compatible(activity);
    }
...
//    private int barNavigationWidth = 0;//虚拟导航栏宽度，没用
    ...
    private AndroidBug5497Workaround_Compatible(final Activity activity) {
